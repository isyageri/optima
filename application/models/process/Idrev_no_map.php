 ...
 *
 */
class Idrev_no_map extends Abstract_model {

   public $table           = "custom.bd29_no_map_m4l";
    public $pkey            = "idrev";
    public $alias           = "a";
    ...
    public $fields          = array(
                                ...
                                'idcat'          => array('nullable' => true, 'type' => 'str', 'unique' => false, 'display' => 'Idcat'),
    ...
    public $fromClause      = "custom.bd29_no_map_m4l a";
