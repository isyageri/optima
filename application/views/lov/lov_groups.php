    ...
    <div class="modal-dialog" style="width:1070px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <thead>
                  <tr>
                     <th data-column-id="id" data-sortable="false" data-visible="false">ID Role</th>
                     <th data-header-align="center" data-align="center" data-formatter="opt-edit" data-sortable="false" data-width="100">Options</th>
                     <th data-column-id="name">Nama Role</th>
        ...
        $("#modal_lov_groups_grid_selection").bootgrid({
             formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="javascript:;" title="Set Value" onclick="modal_lov_groups_set_value(\''+ row.id +'\', \''+ row.name +'\')" class="blue"><i class="fa fa-pencil-square-o bigger-130"></i></a>';
                }
             },
             rowCount:[5,10],
             ajax: true,
             ...
             url: '<?php echo WS_URL."administration.groups_controller/readLov"; ?>',
             selection: true,
             sorting:true
        });
