...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Mapping Account Dengan AM</span>
        </li>
    </ul>
</div>
<!-- end breadcrumb -->
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."account.mapping_account_am_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Customer Ref',name: 'customer_ref',width: 120, align: "left",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
                ...
                {label: 'Account Num',name: 'account_num',width: 100, align: "left",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
                ...
                {label: 'Nama AM',name: 'am_name',width: 100, align: "center",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
                 ...
                 {label: 'Email AM',name: 'am_email',width: 100, align: "center",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
                 ...
                 {label: 'Phone AM',name: 'am_mobile',width: 100, align: "center",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:32
                    },
