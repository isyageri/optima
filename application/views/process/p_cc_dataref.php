...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."process.p_cc_dataref_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'Notel', name: 'p_notel', key: true, width: 100, sorttype: 'text', editable: true, editoptions:{readonly: "readonly"}},
                {label: 'Kode Divre',name: 'p_kode_divre',width: 50, align: "left",editable: true,edittype: 'text',
                    editoptions: {
                        size: 4,
                        maxlength:2,
						// readonly: "readonly"
				...
				{label: 'Bisnis Area',name: 'p_bisnis_area',width: 50, align: "left",editable: true,
                    editoptions: {
                        size: 6,
                        maxlength:6,
						// readonly: "readonly"
                ...
                {label: 'Kode Product',name: 'p_kode_produk',width: 50, hidden:false, align: "left",editable: true,
                    edittype: 'text',
                    editoptions: {
                        size: 10,
                        maxlength:6,
				...
				{label: 'Cust ID',name: 'p_cust_id',width: 150, hidden:false, align: "left",editable: true,
                    edittype: 'text',
                    editoptions: {
                        size: 30,
                        maxlength:60,
				...
				{label: 'Cust Account',name: 'p_cust_account',width: 150, hidden:false, align: "left",editable: true,
                    edittype: 'text',
                    editoptions: {
                        size: 30,
                        maxlength:60,
				...
				{label: 'Flag',name: 'flag',width: 50, hidden:false, align: "left",editable: true,
                    edittype: 'text',
                    editoptions: {
                        size: 30,
                        maxlength:60,
            ...
            editurl: '<?php echo WS_JQGRID."process.p_cc_dataref_controller/crud"; ?>',
            caption: "CC Dataref"
