...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            <span class="caption-subject font-blue-hoki bold uppercase">History Tagihan M4L</span>
        </div>
        <div class="tools">
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-9">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="end_dat" id="end_dat" class="form-control date-picker" data-date-format="yyyymm" placeholder="yyyymm">
                            </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <button style='display:none' type="submit" id="btn_export_excel" class="btn green-haze"><i class="fa fa-file-excel-o"></i> Save to Excel</button>
                            </div>                             
                            </div>                             
...
<script>
    ...
    jQuery(function($) {
		...
		jQuery('#findFilter').click(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam', {
                        url: '<?php echo WS_JQGRID."report.tagihan_m4l_controller/crud"; ?>',
                        datatype: 'json',
    ...
    function exportToExcel() {
        ...
        url += "start_dat=" + $('#start_dat').val();
        url += "&end_dat=" + $('#end_dat').val();
