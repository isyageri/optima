	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table id="grid-table-lov_nipsos" width="100%"></table>
                        <div id="grid-pager-lov_nipsos"></div>
                    </div>
                </div>
			</div>
...
<script>
    ...
    function modal_lov_nipsos_fill_value(rowKey) {
         var code_val = $('#grid-table-lov_nipsos').jqGrid('getCell', rowKey, 'permission_name');
         modal_lov_nipsos_set_value(rowKey, code_val);
    }
    ...
    function modal_lov_nipsos_prepare_table() {
        ...
        var grid_selector = "#grid-table-lov_nipsos";
        var pager_selector = "#grid-pager-lov_nipsos";

        $.jgrid.gridUnload(grid_selector);

        jQuery("#grid-table-lov_nipsos").jqGrid({
            ...
            colModel: [
                ...
                {label: 'Pilih',name: 'permission_id',width: 80, align: "center",editable: false,
                    formatter: function(cellvalue, options, rowObject) {
                        return '<a href="#'+ $("#modal_lov_nipsos_code_val").val() +'" onclick="modal_lov_nipsos_fill_value('+cellvalue+');"> <i class="fa fa-pencil-square-o bigger-200"></i> </a>';
                    }
                },
        ...
        jQuery('#grid-table-lov_nipsos').jqGrid('navGrid', '#grid-pager-lov_nipsos',
            {   //navbar options
                edit: false,
...

            {
                ...
                serializeEditData: modal_lov_nipsos_serializeJSON,
                width: 'auto',
                ...
                beforeShowForm: function (e, form) {
                    var form = $(e[0]);
                    modal_lov_nipsos_style_edit_form(form);
                },
            ...
            {
                //delete record form
                serializeDelData: modal_lov_nipsos_serializeJSON,
                recreateForm: true,
                beforeShowForm: function (e) {
                    var form = $(e[0]);
                    modal_lov_nipsos_style_delete_form(form);
                },
                afterShowForm: function(form) {
                    form.closest('.ui-jqdialog').center();
                },
            ...
            },
            {
                ...
                afterShowSearch: function (e) {
                    var form = $(e[0]);
                    modal_lov_nipsos_style_search_form(form);

                    form.closest('.ui-jqdialog').center();
                },
                afterRedraw: function () {
                    modal_lov_nipsos_style_search_filters($(this));
                }
            },
            {
                //view record form
        ...
        modal_lov_nipsos_responsive_jqgrid(grid_selector, pager_selector);
    }


    function modal_lov_nipsos_serializeJSON(postdata) {
        var items;
    ...
    function modal_lov_nipsos_style_edit_form(form) {
    ...
    function modal_lov_nipsos_style_delete_form(form) {
        var buttons = form.next().find('.EditButton .fm-button');
    ...
    function modal_lov_nipsos_style_search_filters(form) {
    ...
    function modal_lov_nipsos_style_search_form(form) {
    ...
    function modal_lov_nipsos_responsive_jqgrid(grid_selector, pager_selector) {
