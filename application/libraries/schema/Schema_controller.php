...
class Schema_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','e.tariff_name');
        ...
        try {
            ...
            // Filter Table
            $req_param['where'] = array("g.account_status = 'OK'",
                                        "f.product_id = 280",
                                        "e.catalogue_change_id in (select catalogue_change_id
