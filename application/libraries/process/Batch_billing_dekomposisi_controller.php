...
*/
class Batch_billing_dekomposisi_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('process/batch_billing2');
            $table = $ci->batch_billing2;
    ...
    function create() {
        ...
        $items['input_file_name'] = 'DEKOMPOSISI_M4L_'.$items['p_finance_period_id'].'_'.$items['p_bill_cycle_id'];
